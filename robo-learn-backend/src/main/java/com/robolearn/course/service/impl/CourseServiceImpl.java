package com.robolearn.course.service.impl;
...
@Transactional
@Slf4j
public class CourseServiceImpl implements com.robolearn.course.service.CourseService {

    private final CourseRepository courseRepository;
    private final UserRepository userRepository;
    private final CodingProblemRepository codingProblemRepository;
    private final com.robolearn.course.repository.UserCurriculumProgressRepository progressRepository;
    ...
    public void markItemComplete(String email, String courseId, String moduleId, Integer itemOrder, String type) {
        ...
        if (!progressRepository.existsByUserIdAndCourseIdAndModuleIdAndItemOrder(userId, courseId, moduleId, itemOrder)) {
            com.robolearn.course.entity.UserCurriculumProgress progress = com.robolearn.course.entity.UserCurriculumProgress.builder()
                    .userId(userId)
                    .courseId(courseId)
                    .moduleId(moduleId)
                    .itemOrder(itemOrder)
