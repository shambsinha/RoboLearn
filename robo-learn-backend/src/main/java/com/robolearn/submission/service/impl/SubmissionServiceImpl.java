package com.robolearn.submission.service.impl;
...
import com.robolearn.submission.service.CodeExecutionEngine;
...
@Slf4j
public class SubmissionServiceImpl implements com.robolearn.submission.service.SubmissionService {
    ...
    private final org.springframework.kafka.core.KafkaTemplate<String, com.robolearn.submission.dto.request.CodeSubmissionMessage> kafkaTemplate;

    private final com.robolearn.submission.repository.UserSolutionRepository userSolutionRepository;
    private final CourseService courseService;
    private final com.robolearn.course.repository.CourseRepository courseRepository;
    ...
    public String submitCode(String userEmail, CodeSubmissionRequest request) {
        ...
        if (request.isRunOnly()) {
            ...
            try {
                com.robolearn.submission.dto.request.CodeSubmissionMessage message = com.robolearn.submission.dto.request.CodeSubmissionMessage.builder()
                ...
                kafkaTemplate.send(com.robolearn.core.config.KafkaConfig.SUBMISSIONS_TOPIC, message);
            } catch (Exception e) {
    ...
    private void awardXp(Long userId, CodingProblem problem, String code, String language) {
        try {
            ...
            com.robolearn.submission.entity.UserSolution solution = com.robolearn.submission.entity.UserSolution.builder()
                    .userId(userId)
                    .problemId(problem.getId())
                    .solutionCode(code)
                    .language(language)
